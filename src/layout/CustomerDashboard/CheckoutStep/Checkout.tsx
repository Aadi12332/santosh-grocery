        ...
        <div className="bg-[#020618] min-h-svh">
                ...
                <div className="flex items-center justify-between lg:px-6 px-3 py-4 max-w-[1265px] mx-auto flex-wrap gap-3">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="relative" onClick={() => {
                            ...
                            <Search
                                size={18}
                                className="absolute left-3 top-1/2 -translate-y-1/2 text-[#64748B] cursor-pointer"
                            />

                            <input
                                placeholder="Search orders..."
                                className="w-[260px] cursor-pointer h-10 pl-10 pr-4 rounded-lg text-white bg-[#0F172A] border border-[#1E293B] text-sm outline-none"
                            />
            ...
            {step === 5 ? (
                ...
                <div className="grid lg:grid-cols-[1fr_380px] gap-10 py-20 text-white lg:px-6 px-3 max-w-[1265px] mx-auto">
                    ...
                    <div className="border border-[#1E293B] rounded-lg lg:rounded-xl lg:p-6 p-3 h-fit">
