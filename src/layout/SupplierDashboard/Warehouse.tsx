import { Search, Filter, Clock, ArrowLeftRight, Plus, Layers, Grid2X2, MapPin, Move, MoreHorizontal } from "lucide-react"

export default function Warehouse() {

    const stats = [
        { title: "TOTAL STOCK VALUE", value: "$2.4M", note: "+12% vs last month", icon: Layers, color: "text-green-600" },
        { title: "SPACE UTILIZATION", value: "72%", progress: 72, icon: Grid2X2 },
        { title: "ACTIVE BINS", value: "1,240", note: "Out of 1,500 available", icon: MapPin },
        { title: "PENDING MOVES", value: "18", note: "Requires attention", icon: Move, color: "text-orange-600" }
    ]

    const zones = [
        { name: "Zone A: Cold Storage", temp: "-18°C", util: 85, color: "bg-blue-500" },
        { name: "Zone B: Dry Goods", temp: "22°C", util: 62, color: "bg-orange-500" },
        { name: "Zone C: Fresh Produce", temp: "4°C", util: 45, color: "bg-green-500" },
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-3">
                    ...
                    <button className="bg-[#155DFC] text-white rounded-lg px-4 py-2 flex gap-2 items-center">
                        <Plus size={16} />
                        Stock Adjustment
                    </button>
            ...
            <div className="grid lg:grid-cols-4 gap-4">
                ...
                {stats.map((s, i) => {
                    ...
                    return (
                        ...
                        <div key={i} className="border border-[#E5E7EB] bg-white rounded-lg lg:rounded-xl p-4">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div>
                                    ...
                                    {s.note && <p className="text-sm text-green-600 mt-1">{s.note}</p>}
                            ...
                            {s.progress &&
                                <div className="w-full bg-gray-200 h-2 rounded-full mt-4">
                                    <div style={{ width: `${s.progress}%` }} className="bg-[#155DFC] h-2 rounded-full" />
                                </div>
                            }
                            ...
                            {items.map((i, index) => (
                                ...
                                <tr key={index} className="border-b last:border-none">
                                    ...
                                    <td className="py-5">
                                        ...
                                        <span className={`px-3 py-1 rounded-full text-xs ${statusStyles[i.status]}`}>
                                            {i.status}
                                        </span>
